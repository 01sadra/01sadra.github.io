...
ترس از زیادی حرف مفت زدن، باعث شد تمام فصل‌های ابتدایی این کتاب [معروف](https://www.goodreads.com/book/show/35674293-the-complete-software-developer-s-career-guide) که مربوط به آغاز دولوپر شدن بود را بخوانم. ایده‌های خوبی داشت اما زیاد به آن‌ها برنمیگردیم و من بیشتر در مورد مسیر خودم حرف میزنم چرا که داستان از نصیحت جذاب‌تر است. نتیجتا با ما همراه باشید.
...
\[caption id="attachment\_1365" align="aligncenter" width="659"\]![شوخی تصویر به کنار: ) زبان اولتان اگر استرانگ تایپ باشد، احتمالا درک بهتری از بعضی مفاهیم پایه پیدا خواهید کرد: )](images/js-strongtyped-300x168.png) شوخی تصویر به کنار: ) زبان اولتان اگر استرانگ تایپ باشد، احتمالا درک بهتری از بعضی مفاهیم پایه پیدا خواهید کرد: )\[/caption\]
...
\[caption id="attachment\_1367" align="aligncenter" width="722"\]![یادگیری برنامه نویسی](images/Screenshot-2018-3-19-Stack-Overflow-Developer-Survey-20181-300x195.png) برنامه نویس‌ها هم به داکیومنتشن به عنوان منبع اصلی یادگیری نگاه میکنند.\[/caption\]
...
- اکانت گیتهاب باز کنید. برنامه نویسان دیگر را دنبال کنید([مثلا من: )](http://github.com/01sadra) ) کد خوانی بخش مهمی از یادگیری است. طبیعی است که ابتدا خیلی از کدها را نفهمید. از پروژه‌های ساده‌تر شروع کنید. کد‌هایتان را حتی همان آزمایشی‌ها را پابلیش کنید و از دیگران بخواهید که روی آن‌ها نظر بدهند. بعدا میتوانید آن‌ها را پاک کنید. لازم نیست که بگویم کار کردن با گیت را هم یاد بگیرید. برنامه‌نویس بی ورژن کنترل به چه ماند؟هیچ. مجتبی درویشی عزیزم اینجا دو پست([+](http://mojtaba.in/git-for-beginners-part-1/) [+](http://mojtaba.in/git-for-beginners-part-2/)) دارد درباره‌ی گیت و گیتهاب. خواندن آن‌ها را توصیه میکنم، به خصوص اگر تازه کارید.
